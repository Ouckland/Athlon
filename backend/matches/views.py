...
def match_lineup_view(request, pk, team_id):
    ...
    # PUT — single authorization gate before touching the body.
    # All other rules (team in match, team in competition, 11 starters,
    # match SCHEDULED, ...) live in submit_lineup() so any caller gets them.
